...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_SNEASEL]               = {{EVO_ITEM, ITEM_RAZOR_CLAW, SPECIES_WEAVILE}},    //modified, hirer
    [SPECIES_SNEASEL_HISUIAN]       = {{EVO_ITEM, ITEM_RAZOR_CLAW, SPECIES_SNEASLER}},   //I ADDED THIS, HIRER
#endif
