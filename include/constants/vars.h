...
#define VAR_LITTLEROOT_TOWN_GROVE                        0x404E // Blocking Grove drizzit
#define VAR_LOTAD_SIZE_RECORD                            0x404F
#define VAR_LITTLEROOT_TOWN_STATE                        0x4050
#define VAR_OLDALE_TOWN_STATE                            0x4051
#define VAR_DEWFORD_TOWN_STATE                           0x4052 // 0 means winona hasn't been to granite cave yet, 1 means brawly and winona in granite cave, 2 means brawly and winona left
...
#define VAR_UNUSED_0x408B                                0x408B // Unused Var may lab state hirer
#define VAR_LITTLEROOT_HOUSES_STATE_BRENDAN              0x408C
#define VAR_LITTLEROOT_RIVAL_STATE                       0x408D
#define VAR_BOARD_BRINEY_BOAT_STATE                      0x408E
#define VAR_DEVON_CORP_3F_STATE                          0x408F
#define VAR_BRINEY_HOUSE_STATE                           0x4090
#define VAR_MOM_START_STATE                              0x4091 // Unused Var trigger mom first hirer
...
#define VAR_BRAWLY_POSITION                              0x40F7 // Brawly location
